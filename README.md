...
A love letter to Idaho, America’s public lands, and the freedom we find outdoors.

**The Bureau of Radical Recreation**

Single-page static website with supplied National Park sign, full original Artist Statement, and Smokey Larry artwork. Uses the approved Field Paper / Ranger Brown palette with Besley headings, National Park body text, and Roadgeek lettering.
...
- `index.html`: page copy and metadata.
- `styles.css`: layout, typography, colors, and motion.
- `script.js`: progressive animation, with reduced-motion support.
- `assets/`: website artwork, self-hosted fonts, and license notices.
